...
static DBPrefsWindowController *_sharedPrefWindowController = nil;
...
+ (DBPrefsWindowController *)sharedPrefWindowController
{
	if (!_sharedPrefWindowController) {
		_sharedPrefWindowController = [[self alloc] initWithWindowNibName:[self nibName]];
	}
	return _sharedPrefWindowController;
}
